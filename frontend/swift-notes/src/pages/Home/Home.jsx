...
const Home = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-white text-black dark:bg-gray-900 dark:text-gray-50 dark:text-opacity-90">
      <Navbar
        userInfo={userInfo}
      ...
      <Modal
        ...
        className="w-[40%] max-h-3/4 bg-white rounded-md mx-auto mt-14 p-5 overflow-scroll dark:bg-gray-700"
      >
        <AddEditNotes
